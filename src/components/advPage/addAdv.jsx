...
const AddAdv=()=>{
    ...
    return(
        ...
        <div className="homeNav">
            ...
            ADD  Your (  NEW HomePage Advertisement ) 
            </div>
            </div>
            <div className="bodyAdd">
                <section className="sec1Add">
                    ...
                    <textarea className="destext"> We have a Good Opportunity for flats for sale in Baghdad for new married persons with a good prices you can contact us any time during the week</textarea>
